...
return (
            <div className={styles['menubar-menu']}>   
                    ...
                    <p className={styles['bc-link']}>
                        <a href="https://www.linkedin.com/in/joe-ward1/" title="LinkedIn" alt="LinkedIn" target="_blank" rel="noreferrer" className={styles['bc-work-icon']}>
                        <Image src="/icon-linkedin-blue.png" alt="LinkedIn" layout="fill"></Image></a>
                    LinkedIn</p>

                    <p className={styles['bc-link']} >
                        <a href="https://github.com/jjward25" title="Github" alt="Github" target="_blank" rel="noreferrer" className={styles['bc-work-icon']}>
                        <Image src="/icon-github-clear.png" alt="Github" layout="fill"></Image></a>
                    Github</p>
                    
                    <p className={styles['bc-link']} >
                        <a href="https://public-docs2.s3.amazonaws.com/Joseph+Ward.pdf" title="Resume" alt="Resume" target="_blank" rel="noreferrer" className={styles['bc-work-icon']}>
